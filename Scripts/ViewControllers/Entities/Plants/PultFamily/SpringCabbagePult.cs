...
{
    public sealed class SpringCabbagePult : Plant
    {
        public override PlantDef Def { get; } = new PlantDef(PlantId.CabbagePult, PlantVariant.V1);
        ...
        protected override void OnUpdate()
        {
            ...
            if (_timer.Ready && _detectTimer.Ready)
            {
                ...
                {
                    _timer.Reset();
                    _ProjectileService.CreatePea(ProjectileId.SpringCabbage, _direction, FirePoint.position);
                }
            }
        }
    }
