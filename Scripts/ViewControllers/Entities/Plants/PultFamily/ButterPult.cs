...
{
    public sealed partial class ButterPult : Plant
    {
        public override PlantDef Def { get; } = new PlantDef(PlantId.KernelPult, PlantVariant.V1);
    ...
    public partial class ButterPult
    {
