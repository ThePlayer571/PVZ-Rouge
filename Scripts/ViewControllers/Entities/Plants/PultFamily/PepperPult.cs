...
{
    public sealed class PepperPult : Plant
    {
        public override PlantDef Def { get; } = new PlantDef(PlantId.PepperPult, PlantVariant.V0);
        ...
        protected override void OnUpdate()
        {
            ...
            if (_timer.Ready && _detectTimer.Ready)
            {
                ...
                {
                    _timer.Reset();
                    _ProjectileService.CreatePea(ProjectileId.Pepper, _direction, FirePoint.position);
                }
            }
        }
    }
