...
{
    public sealed class WinterMelon : Plant
    {
        public override PlantDef Def { get; } = new PlantDef(PlantId.WinterMelon, PlantVariant.V0);
        ...
        protected override void OnUpdate()
        {
            ...
            if (_timer.Ready && _detectTimer.Ready)
            {
                ...
                {
                    _timer.Reset();
                    _ProjectileService.CreatePea(ProjectileId.FrozenMelon, _direction, FirePoint.position);
                }
            }
        }
    }
