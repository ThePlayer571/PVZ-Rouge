...
namespace TPL.PVZR.Classes.ZombieAI.Public
{
    ...
    {
        public const int PASSABLE_HEIGHT_CEILING = 3;
        public const int PASSABLE_HEIGHT_CEILING_WITH_OFFSET = 4; // 请至少设为“游戏内最大僵尸高度+1”，不然存在“高度差”的地形都无法正确处理
        ...
        public static AITendency CanPutLadder => new AITendency(MainAI.CanPutLadder, 2);
