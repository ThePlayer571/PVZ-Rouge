    ...
    public class EdgeWeightCalculator
    {
        ...
        public EdgeWeightCalculator()
        {
            _weightRules = new Dictionary<(Edge.EdgeType, AITendency.MainAI), float>
            {
                ...
                {(Edge.EdgeType.Ladder, AITendency.MainAI.Default), 100f},
                {(Edge.EdgeType.Ladder, AITendency.MainAI.CanPutLadder), 1f},
                {(Edge.EdgeType.Ladder, AITendency.MainAI.CanSwim), 100f},

                {(Edge.EdgeType.Climb, AITendency.MainAI.Default), 10f},
                {(Edge.EdgeType.Climb, AITendency.MainAI.CanPutLadder), 10f},
                {(Edge.EdgeType.Climb, AITendency.MainAI.CanSwim), 10f},
            };
        }
